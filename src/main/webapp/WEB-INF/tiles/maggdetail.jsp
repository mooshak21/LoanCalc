...
<c:if test="${loanEntries1 != null  || loanEntries2 != null }">
    <form name="loanAggregateForm1" id="loanAggregateForm1" action="/updateaggregate" method="POST"
          onsubmit='if(loanAggregateForm1.name1.value == ""  && loanAggregateForm1.type1.value == "" && loanAggregateForm1.email1.value == "" && loanAggregateForm1.startDate1.value == "" && loanAggregateForm1.term1.value == ""){ alert("Please enter all the fields"); loanAggregateForm1.name.focus(); return false;}'>
                ...
                <div class="card-block">
                    ...
                    <div class="form-group row">
                        ...
                        <select class="form-control resetMe" name="type" required="true" id="type" >
                            ...
                            <option value="Home & Student Loan" ${type == 'Home & Student Loan' ? 'selected' : ''}>Home & Student Loan</option>
                        </select>
                    </div>
