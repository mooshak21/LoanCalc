...
<html lang="en" dir="ltr">
  <head>
    ...
    <!--Import Google Icon Font-->
          ...
          <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/css/index.css"  media="screen,projection"/>
  ...
  <body>
    ...
    <section class="loansegment">
      <div class="slider">
        <ul class="slides">
          <li>
            <img style="max-width:100%;" src="${pageContext.request.contextPath}/css/a1.jpg"> <!-- random image -->
          ...
          <li>
            <img style="max-width:100%;" src="${pageContext.request.contextPath}/css/b1.jpg"> <!-- random image -->
            <div class="caption left-align">
          ...
          <li>
            <img style="max-width:100%;" src="${pageContext.request.contextPath}/css/c1.jpg"> <!-- random image -->
            <div class="caption left-align">
          ...
          <li>
            <img style="max-width:100%;" src="${pageContext.request.contextPath}/css/d1.jpg"> <!-- random image -->
            <div class="caption left-align">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/css/materialize.min.js"></script>
