  ...
  <body>
    ...
    <section class="loansegment">
      <div class="slider">
        <ul class="slides">
          <li>
            <img style="max-width:100%;" src="/WEB-INF/css/a1.jpg"> <!-- random image -->
          ...
          <li>
            <img style="max-width:100%;" src="/WEB-INF/css/b1.jpg"> <!-- random image -->
            <div class="caption left-align">
          ...
          <li>
            <img style="max-width:100%;" src="/WEB-INF/css/c1.jpg"> <!-- random image -->
            <div class="caption left-align">
          ...
          <li>
            <img style="max-width:100%;" src="/WEB-INF/css/d1.jpg"> <!-- random image -->
            <div class="caption left-align">
    ...
    <script type="text/javascript" src="/WEB-INF/css/materialize.min.js"></script>
